...
namespace StartToBike.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(StartToBikeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Email,Password,Sex,Height,Age,WeightGoal,Rol")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Email,Password,Sex,Height,Age,WeightGoal,Rol")] User user)
        {
            if (id != user.ID)
            {
                return NotFound();
